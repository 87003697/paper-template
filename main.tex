...
\begin{abstract}
  Despite the success of 3D native generators, their generalization to highly stylized scenarios is constrained by the scarcity of diverse 3D training data. 
  This limitation frequently results in semantic misalignment and consequent geometric or textual distortion.
  ...
  To optimize the 3D generator, these view-space signals are leveraged via a contrastive loss, with the resulting gradients backpropagated through the entire generation trajectory. 
